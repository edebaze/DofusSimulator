...
class RewardList:
    ...
    BAD_MOVEMENT = -20            # reward for making a bad movement action
    BAD_SPELL_CASTING = -50       # reward for casting a spell without being in enemy's range
    BAD_SPELL_SELECTION = -20     # reward for trying to cast a spell without the necessary amount of PA
